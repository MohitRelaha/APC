...
{
	int h_ptrn = 0 ;  //Hash Value of Pattern
	int h_str = 0 ;   //Hash Value of String
	int len_str = strlen(str);
	int len_ptrn = strlen(ptrn);
	int mod = 1000000000 + 9 ;
	int prime = 7 ;		// Take any prime no.
	
	int i;
	// Calculating Hash Value for Pattern And for String(for len_ptrn chars)
